const SMSUITE_CHANGELOG_DATA = {
  ...
  "SMFluxBridge": {
    ...
    "versions": [
      {
        "version": "1.2.5",
        "title": "SMFluxBridge™ 1.2.5 — SignalR Logging Metadata Hotfix",
        "date": "Release Build",
        "subCategory": null,
        ...
        "channel": "Release",
        "target": "Paper 1.20.4+",
        "content": "# SMFluxBridge™ 1.2.5 — SignalR Logging Metadata Hotfix\n\n- Preserves all SMFluxBridge™ 1.2.4 FluxStore, subscriptions, Discord linking, linked identity, journaling, recovery, and audit functionality.\n- Adds the relocated SLF4J service-provider metadata required by FluxStore's shaded SignalR runtime.\n- Uses the same NOP SLF4J provider declared by FluxStore's official plugin, eliminating the false `No SLF4J providers were found` / NOP fallback ERROR spam without changing delivery behavior.\n- Updates the FluxStore authentication plugin version to 1.2.5.\n- Updates bundled plugin/config version metadata to 1.2.5.\n"
      },
      {
        "version": "1.2.4",
        "title": "SMFluxBridge™ 1.2.4 — FluxStore Official SignalR Runtime Parity",
        "date": "Release Build",
        "subCategory": null,
        ...
        "channel": "Release",
        "target": "Paper 1.20.4+",
        "content": "# SMFluxBridge™ 1.2.4 — FluxStore Official SignalR Runtime Parity\n\n- Replaced the hand-written minimal SignalR transport with the same shaded Microsoft SignalR Java runtime bundled in the user-supplied official FluxStore 1.0.0 plugin.\n- Delegates SignalR negotiate, cookies, WebSocket framing, protocol handshake, keepalive, invocation binding, and close semantics to the proven reference runtime.\n- Keeps SMFluxBridge's durable command journal, no-blind-replay safety, subscription API, Discord linking, Linked Account role, staff lookups, and notification tests unchanged.\n- Converts FluxStore `ExecuteCommands` payloads into SMFluxBridge's existing safe execution model; the official FluxStore plugin itself is not included or enabled.\n- No config, linked-account, subscription, or journal migration.\n"
      },
      {
        "version": "1.2.3",
        "title": "SMFluxBridge™ 1.2.3 — SignalR Binary Frame Parity Hotfix",
        "date": "Release Build",
        "subCategory": null,
